...
# MAC du sender confirmée par le monitor ESP-IDF (format sans les :)
TARGET_MAC = "700810EA3DA0"

class CSIReader:
    def __init__(self, port="/dev/ttyUSB0", baudrate=115200, output_csv=None, target_mac=TARGET_MAC):
        self.port = port
        ...
        self.ignored_wrong_mac_count = 0
        self.ser = None
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # Filtrage sur la MAC du sender
                if row["mac"] != self.target_mac:
                    self.ignored_wrong_mac_count += 1
                    continue
            ...
            print(f"Ignored wrong MAC lines: {self.ignored_wrong_mac_count}")
        finally:
